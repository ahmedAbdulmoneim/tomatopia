  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AdminCubit, AdminStates>(
      listener: (context, state) {
        if (state is AddTipSuccessState) {
          show(context, context.done, context.tipAddedSuccessfully,
              Colors.green);
        ...
        } else if (state is AddTipFailureState) {
        ...
        return Form(
          ...
          child: Scaffold(
                  ...
                  onPressed: () {
                    if (formKey.currentState!.validate()) {
                      if (adminCubit.imageFile != null) {
                        ...
                        show(context, context.error, context.pleaseSelectImage,
                            Colors.red);
                      }
                    }
                  },
            ...
            body: ConditionalBuilder(
              condition: state is AddTipLoadingState,
              builder: (context) =>
                  Center(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: FileImage(adminCubit.imageFile!),
                              ),
                            ),
                          )
                      ],
