...
class GetAllCategoryInitialState extends AdminStates {}

class GetAllCategoryLoadingState extends AdminStates {}

class GetAllCategorySuccessState extends AdminStates {}

class GetAllCategoryFailureState extends AdminStates {}

class DeleteCategoryLoadingState extends AdminStates {}

class DeleteCategorySuccessState extends AdminStates {}

class DeleteCategoryFailureState extends AdminStates {}

class EditeCategoryLoadingState extends AdminStates {}

class EditeCategorySuccessState extends AdminStates {}

class EditeCategoryFailureState extends AdminStates {}

class AddCategoryLoadingState extends AdminStates {}

class AddCategorySuccessState extends AdminStates {}

class AddCategoryFailureState extends AdminStates {}

class GetAllDiseaseInitialState extends AdminStates {}

class GetAllDiseaseLoadingState extends AdminStates {}

class GetAllDiseaseSuccessState extends AdminStates {}
...
class AddDiseaseFailureState extends AdminStates {}

class GetDiseaseByNameLoadingState extends AdminStates {}

class GetDiseaseByNameSuccessState extends AdminStates {}
